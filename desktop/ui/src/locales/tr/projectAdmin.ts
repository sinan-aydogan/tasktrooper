...
export const projectAdmin: ProjectAdminDict = {
  ...
  projects: {
    ...
    dropToLink: "{project} projesine bağlamak için buraya bırakın",
    dropToUnlink: "Projeden çıkarmak için buraya bırakın",
    repoLinked: "{repo}, {project} projesine bağlandı",
    repoUnlinked: "{repo} projenin bağından çıkarıldı",
    dragToReassign: "Projeye bağlamak veya taşımak için sürükleyin",
