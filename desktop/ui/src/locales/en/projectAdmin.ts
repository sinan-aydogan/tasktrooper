...
export const projectAdmin = {
  ...
  projects: {
    ...
    dropToLink: "Drop to link to {project}",
    dropToUnlink: "Drop here to unlink from project",
    repoLinked: "Linked {repo} to {project}",
    repoUnlinked: "Unlinked {repo} from project",
    dragToReassign: "Drag to move or link to a project",
